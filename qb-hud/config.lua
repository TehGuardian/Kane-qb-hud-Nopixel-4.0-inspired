...
Config.vehicles = {
    [joaat('futo')] = {
        [1] = {3.33, 1.92, 1.36, 1.05, 0.90},--5
        [2] = {3.33, 1.95, 1.39, 1.09, 0.95, 0.90},--6
    },
    [joaat('nero')] = {
        [3] = {4.205, 2.523364, 1.892523, 1.4509, 1.17757, 0.988, 0.90},--7
        [4] = {5.31, 3.11, 2.22, 1.74, 1.51, 1.43, 1.20, 0.90},--8
    },
    [joaat('gauntlet4')] = {
        [5] = {6.36, 4.24, 2.8416, 2.249, 1.733, 1.349, 1.132, 0.90},--8
        [6] = {7.70, 4.51, 3.22, 2.52, 2.20, 2.08, 1.73, 1.31, 0.90}--9
    },
}
